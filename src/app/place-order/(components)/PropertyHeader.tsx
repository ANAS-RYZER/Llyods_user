...
const PropertyHeader: React.FC<PropertyHeaderProps> = ({
  ...
  <div className="flex justify-between items-center mt-10 max-w-6xl mx-auto ">
      ...
      <div className="flex flex-wrap gap-2 mt-3 ml-3">
        <div className="rounded-full flex w-auto h-auto">
          ...
          <div className="flex justify-center gap-0 items-center bg-gray-300 rounded-r-full p-1 text-[12px] font-medium mr-2 pr-2 text-black">
            <DollarSign size={12} /> {property?.tokenInformation?.tokenPrice} Per Token
          </div>
        </div>
        <Badge
          variant="outline"
    ...
    {/* Right Section */}
    <div>
      <div className="flex justify-between items-center px-3 py-3 bg-white rounded-xl shadow gap-28">
        ...
        <div className="flex">
          <Button variant="default" className="bg-gray-700 mx-1 p-3">
            <PhoneCall />
          </Button>
          <Button variant="default" className="bg-gray-700 mx-1 px-3">
               <svg
