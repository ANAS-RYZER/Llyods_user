...
const Feature: React.FC<Props> = ({ features, amenities }) => {
    ...
    const renderItems = (items: Props["features"], ref: React.RefObject<HTMLDivElement>) => (
    ...
    return (
        ...
        >
            <Tabs defaultValue="features" className="w-full">
                ...
                <TabsContent value="features">{renderItems(features, featureRef)}</TabsContent>
                <TabsContent value="amenities">{renderItems(amenities, amenityRef)}</TabsContent>
            </Tabs>
        </FandoraCard>
