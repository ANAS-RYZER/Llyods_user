...
import { validateForm } from '@/constants/helper'
                ...
                <div className="flex  bg-blue-50/30 items-center justify-between gap-2 mb-4 p-4">
                    <div>
                        ...
                        {isLoading ? (
                            ...
                            <p className="text-sm text-gray-500"> 'Your  contact  details for your account security and verification.'</p>
                        )}
                            ...
                            {isLoading ? (
                                ...
                                <>
                                    <div className="flex gap-2">
                                        ...
                                        <Input type="number" disabled={!editMode} {...form.register('mobileNumber')} />
                                    </div>
                                </>
                            )}
                        </div>
