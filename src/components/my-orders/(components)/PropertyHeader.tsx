...
const PropertyHeader = ({
  ...
  return (
    <div className="flex justify-center items-center gap-10 mt-10 w-full bg-white/40">
      <div className="w-[37%] flex flex-col justify-start">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold flex gap-1 items-center">
            <span> {property?.name},</span> <span>{property?.city},</span>{" "}
      ...
      <div
        className={` flex justify-between items-center  px-3 py-3 bg-white rounded-xl lg:w-[400px]   ${
          assetmanager ? "shadow" : ""
        }`}
      >
        {assetmanager && (
