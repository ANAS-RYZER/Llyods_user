...
import { ChevronDown, Copy, MapPin, IndianRupee, Euro } from 'lucide-react'
  ...
  return (
    <div>
              ...
              <div className="flex justify-between items-end">
                <div>
                  <div className="text-lg font-semibold">{orderValue?.tokensBooked} Tokens</div>
                  <div className="text-sm text-[#6a7381]">(Per token: € {orderValue?.asset?.tokenInformation?.tokenPrice})</div>
                </div>
                <div>
                  ...
                  <div className="text-lg justify-end flex items-center gap-1 font-semibold">
                    <Euro size={12} />  {orderValue?.totalOrderValue}
                  </div>
                </div>
              </div>
