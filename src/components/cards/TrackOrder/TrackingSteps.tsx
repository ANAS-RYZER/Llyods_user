    ...
    return (
        ...
        <div className="relative flex items-start space-x-3">
            ...
            <div className="flex justify-between">
                ...
                <span className="text-sm text-gray-500">{step.completedAt && formatDate(step.completedAt)}</span>
            ...
            <div className="mt-2">
                ...
                <span className="text-sm text-gray-500">Completed on {formatDate(step.completedAt)}</span>
                )}

              
                {/* Action buttons based on step */}
                {step.status === "awaiting-documents-to-be-signed" && (
                <button className="mt-2 bg-blue-600/20 rounded-full text-blue-600 px-2 py-1 inline-flex items-center text-sm font-medium">
                    <span className="mr-1"></span> View Documents
                </button>
                )}
