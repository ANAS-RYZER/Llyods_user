...
import { CalculateReturns } from "@/components/cards/PropertyCard/CalculateReturns";
import { InfoIcon } from "@/components/common/InfoIcon";
import React from "react";

export default function YearlyReturnsTab({
  fees,
  orderCalculations,
  propertyValues,
  quantity,
  ...
  yearlyGrossYield: number;
  yearlyNetYield: number;
  ownerShipPercantage: number;
  yearlyNetReturns: number;
}) {
  return (
    <div>
      ...
      <div className="flex justify-between py-4 px-1">
        <div className="flex items-center gap-2">
          <span className="text-gray-600 text-sm flex items-center gap-1">
            Cost per Token <InfoIcon tooltip="dummy data" size={12} />
          </span>
        </div>
        <div className="flex items-center gap-2">
