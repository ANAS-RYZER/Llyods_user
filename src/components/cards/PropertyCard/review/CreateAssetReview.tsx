...
import { Textarea } from "@/components/ui/textarea"; // Assuming this is correct based on usage
import {toast} from "react-toastify";

interface CreateAssetReviewProps {
  open?: boolean;
  onOpenChange?: (open: boolean) => void;
  onSubmitChange?: (open: boolean) => void;
}

const CreateAssetReview: React.FC<CreateAssetReviewProps> = ({
  open,
  onOpenChange,
  onSubmitChange,
}) => {
        ...
        <div className="p-4 pt-6 flex flex-col gap-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              {rating > 0 && (
                <p className="text-sm font-medium text-[#725ACE]">
            ...
            <Button
              ...
              onClick={() => {
                toast.success("Review submitted", {
                  position: "top-right",
                  autoClose: 3000,
                }); // Using toast.success for a success message
...
export default CreateAssetReview;
