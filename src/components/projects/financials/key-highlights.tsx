    ...
    >
      <div className="grid grid-cols-1  rounded-xl md:grid-cols-2 gap-2 p-4 bg-gray-50 m-2">
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Asset Style ${keyHighlights.assetStyle}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Projected IRR ${keyHighlights.irr}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          icon={<PoundSterling size={16} className=" text-gray-600" />}
          label="Total Asset Value"
          value={formatCurrency(keyHighlights.totalAssetValue)}
          info={
            <InfoIcon
              tooltip={`Total Asset Value ${keyHighlights.totalAssetValue}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Total Area (SFT) ${keyHighlights.totalAreaSqft}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Price per SFT ${keyHighlights.pricePerSqft}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Ownership Type ${keyHighlights.ownershipType}`}
              size={12}
            />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon tooltip={`SPV Name ${keyHighlights.spvName}`} size={12} />
          }
        />
        ...
        <HighlightItem
          ...
          info={
            <InfoIcon
              tooltip={`Instrument Type ${keyHighlights.instrumentType}`}
              size={12}
            />
          }
        />
